...
{
    /// <inheritdoc />
    public partial class AddParasutConnection : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ParasutConnections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ParasutConnections_Projects_ProjectId",
